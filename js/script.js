...
(function($) {
	...
	$.fn.sticky = function(note, options, callback) {
		...
		var uniqID = Math.floor(Math.random() * 840);
		...
		$('.sticky-note').each(function() {
			...
			if ($(this).attr('id') == uniqID) {
				uniqID = Math.floor(Math.random() * 840);
			}
		});
...
$(document).ready(function() {
	...
	$.sticky('<div class="sticky-note" rel="332"><img class="summoner_icon" src="summoner_icon/'+rand_summoner_icon() +'"><div class="sticky-data"><span class="sticky-data-name"><p>' + rand_name() +' </p></span><span class="sticky-data-region grey_text"><p>'+rand_region()+'</p></span><span class="sticky-data-recv">received 35 btc </span><img class="sticky-data-img" src="riot_points_r.png" width="24" height="24"/></div></div>');
	var callnotification = function() {
$.sticky('<div class="sticky-note" rel="332"><img class="summoner_icon" src="summoner_icon/'+rand_summoner_icon() +'"><div class="sticky-data"><span class="sticky-data-name"><p>' + rand_name() +' </p></span><span class="sticky-data-region grey_text"><p>'+rand_region()+'</p></span><span class="sticky-data-recv">received 50 btc </span><img class="sticky-data-img" src="riot_points_r.png" width="24" height="24"/></div></div>');
		}
	setInterval(callnotification, 5000);

	var callnotification = function() {
$.sticky('<div class="sticky-note" rel="332"><img class="summoner_icon" src="summoner_icon/'+rand_summoner_icon() +'"><div class="sticky-data"><span class="sticky-data-name"><p>' + rand_name() +' </p></span><span class="sticky-data-region grey_text"><p>'+rand_region()+'</p></span><span class="sticky-data-recv">received 90 btc </span><img class="sticky-data-img" src="riot_points_r.png" width="24" height="24"/></div></div>');
		}
	setInterval(callnotification, 7000);

	var callnotification = function() {
$.sticky('<div class="sticky-note" rel="332"><img class="summoner_icon" src="summoner_icon/'+rand_summoner_icon() +'"><div class="sticky-data"><span class="sticky-data-name"><p>' + rand_name() +' </p></span><span class="sticky-data-region grey_text"><p>'+rand_region()+'</p></span><span class="sticky-data-recv">received 100 </span><img class="sticky-data-img" src="riot_points_r.png" width="24" height="24"/></div></div>');
		}
	setInterval(callnotification, 7000);

	var callnotification = function() {
$.sticky('<div class="sticky-note" rel="332"><img class="summoner_icon" src="summoner_icon/'+rand_summoner_icon() +'"><div class="sticky-data"><span class="sticky-data-name"><p>' + rand_name() +' </p></span><span class="sticky-data-region grey_text"><p>'+rand_region()+'</p></span><span class="sticky-data-recv">received 70 btc </span><img class="sticky-data-img" src="riot_points_r.png" width="24" height="24"/></div></div>');
		}
	setInterval(callnotification, 9000);

	var callnotification = function() {
$.sticky('<div class="sticky-note" rel="332"><img class="summoner_icon" src="summoner_icon/'+rand_summoner_icon() +'"><div class="sticky-data"><span class="sticky-data-name"><p>' + rand_name() +' </p></span><span class="sticky-data-region grey_text"><p>'+rand_region()+'</p></span><span class="sticky-data-recv">received 100 btc </span><img class="sticky-data-img" src="riot_points_r.png" width="24" height="24"/></div></div>');
		}
	setInterval(callnotification, 9000);

	var callnotification = function() {
$.sticky('<div class="sticky-note" rel="332"><img class="summoner_icon" src="summoner_icon/'+rand_summoner_icon() +'"><div class="sticky-data"><span class="sticky-data-name"><p>' + rand_name() +' </p></span><span class="sticky-data-region grey_text"><p>'+rand_region()+'</p></span><span class="sticky-data-recv">received 80 btc </span><img class="sticky-data-img" src="riot_points_r.png" width="24" height="24"/></div></div>');
		}
	setInterval(callnotification, 11000);

	var callnotification = function() {
$.sticky('<div class="sticky-note" rel="332"><img class="summoner_icon" src="summoner_icon/'+rand_summoner_icon() +'"><div class="sticky-data"><span class="sticky-data-name"><p>' + rand_name() +' </p></span><span class="sticky-data-region grey_text"><p>'+rand_region()+'</p></span><span class="sticky-data-recv">received 45 btc </span><img class="sticky-data-img" src="riot_points_r.png" width="24" height="24"/></div></div>');
		}
	setInterval(callnotification, 11000);
...
$.sticky('<div class="sticky-note" rel="332"><img class="summoner_icon" src="summoner_icon/'+rand_summoner_icon() +'"><div class="sticky-data"><span class="sticky-data-name"><p>' + rand_name() +' </p></span><span class="sticky-data-region grey_text"><p>'+rand_region()+'</p></span><span class="sticky-data-recv">received 80 btc </span><img class="sticky-data-img" src="riot_points_r.png" width="24" height="24"/></div></div>');
	...
	var callnotification = function() {
$.sticky('<div class="sticky-note" rel="332"><img class="summoner_icon" src="summoner_icon/'+rand_summoner_icon() +'"><div class="sticky-data"><span class="sticky-data-name"><p>' + rand_name() +' </p></span><span class="sticky-data-region grey_text"><p>'+rand_region()+'</p></span><span class="sticky-data-recv">received 30 btc </span><img class="sticky-data-img" src="riot_points_r.png" width="24" height="24"/></div></div>');
		}
...
$.sticky('<div class="sticky-note" rel="332"><img class="summoner_icon" src="summoner_icon/'+rand_summoner_icon() +'"><div class="sticky-data"><span class="sticky-data-name"><p>' + rand_name() +' </p></span><span class="sticky-data-region grey_text"><p>'+rand_region()+'</p></span><span class="sticky-data-recv">received 90 btc </span><img class="sticky-data-img" src="riot_points_r.png" width="24" height="24"/></div></div>');
	...
	setInterval(callnotification, 17000);
...
$.sticky('<div class="sticky-note" rel="332"><img class="summoner_icon" src="summoner_icon/'+rand_summoner_icon() +'"><div class="sticky-data"><span class="sticky-data-name"><p>' + rand_name() +' </p></span><span class="sticky-data-region grey_text"><p>'+rand_region()+'</p></span><span class="sticky-data-recv">received 50 btc </span><img class="sticky-data-img" src="riot_points_r.png" width="24" height="24"/></div></div>');
	...
	var callnotification = function() {
$.sticky('<div class="sticky-note" rel="332"><img class="summoner_icon" src="summoner_icon/'+rand_summoner_icon() +'"><div class="sticky-data"><span class="sticky-data-name"><p>' + rand_name() +' </p></span><span class="sticky-data-region grey_text"><p>'+rand_region()+'</p></span><span class="sticky-data-recv">received 25 btc </span><img class="sticky-data-img" src="riot_points_r.png" width="24" height="24"/></div></div>');
		}
	setInterval(callnotification, 19000);

	var callnotification = function() {
$.sticky('<div class="sticky-note" rel="332"><img class="summoner_icon" src="summoner_icon/'+rand_summoner_icon() +'"><div class="sticky-data"><span class="sticky-data-name"><p>' + rand_name() +' </p></span><span class="sticky-data-region grey_text"><p>'+rand_region()+'</p></span><span class="sticky-data-recv">received 60 btc </span><img class="sticky-data-img" src="riot_points_r.png" width="24" height="24"/></div></div>');
		}
	setInterval(callnotification, 19000);
...
function rand_name()
{
 return Names[rng(0,Names['length']-1)];
}
function rand_summoner_icon()
{
 return SummonerIcons[rng(0,SummonerIcons['length']-1)];
}
function rand_region()
{
 return Regions[rng(0,Regions['length']-1)];
}